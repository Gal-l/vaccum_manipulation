...
class ABB_Controll:
  ...
  def prepare_waypoints_array_for_cartesian_path(self,waypoints_array):
    ...
    for waypoint in waypoints_array:
      ...
      wpose.position.x += waypoint.position.x - wpose.position.x

      wpose.position.y += waypoint.position.y - wpose.position.y

      wpose.position.z += waypoint.position.z - wpose.position.z

      wpose.orientation = waypoint.orientation
...
class Gripper_switcher:
  ...
  def execute_cartesian_path(self,waypoints_array):

    self.controll.plan = self.controll.plan_cartesian_path(waypoints_array)
  ...
  def load_glue_gripper(self):
    ...
    glue_gripper_waypoints = [self.home_pose , self.glue_gripper_prep_pose , self.glue_gripper_in_pose]

    self.execute_cartesian_path(glue_gripper_waypoints)
    ...
    glue_gripper_waypoints = [self.glue_gripper_out_pose , self.home_pose]
  ...
  def return_glue_gripper(self):
    ...
    glue_gripper_waypoints = [self.glue_gripper_out_pose ,self.glue_gripper_in_pose ]
    ...
    glue_gripper_waypoints = [self.glue_gripper_prep_pose , self.home_pose]
  ...
  def load_fingers_gripper(self):
    ...
    fingers_waypoints = [self.home_pose , self.fingers_gripper_prep_pose , self.fingers_gripper_in_pose]

    self.execute_cartesian_path(fingers_waypoints)
    ...
    fingers_waypoints = [self.fingers_gripper_out_pose , self.home_pose ]
  ...
  def return_fingers_gripper(self):
    ...
    fingers_waypoints = [self.fingers_gripper_out_pose , self.fingers_gripper_in_pose]
    ...
    fingers_waypoints = [self.fingers_gripper_prep_pose , self.home_pose]
  ...
  def load_vaccum_gripper(self):
    ...
    vaccum_gripper_waypoints = [self.home_pose,self.vaccum_gripper_prep_pose , self.vaccum_gripper_in_pose]

    self.execute_cartesian_path(vaccum_gripper_waypoints)
    ...
    vaccum_gripper_waypoints = [self.vaccum_gripper_out_pose , self.home_pose]
  ...
  def return_vaccum_gripper(self):
    ...
    vaccum_gripper_waypoints = [self.vaccum_gripper_out_pose , self.vaccum_gripper_in_pose]
    ...
    vaccum_gripper_waypoints = [self.vaccum_gripper_in_pose,self.vaccum_gripper_prep_pose , self.home_pose]
  ...
  def add_grippers_to_scene(self):
    ...
    fingers_gripper_mesh_pose.pose.position.x ,fingers_gripper_mesh_pose.pose.position.y ,fingers_gripper_mesh_pose.pose.position.z   = 0.21,-0.49,0.35

    vaccum_gripper_mesh_pose.pose.orientation.x,vaccum_gripper_mesh_pose.pose.orientation.y,vaccum_gripper_mesh_pose.pose.orientation.z,vaccum_gripper_mesh_pose.pose.orientation.w =  0.7103533, 0, 0, 0.7038453  

    vaccum_gripper_mesh_pose.pose.position.x ,vaccum_gripper_mesh_pose.pose.position.y ,vaccum_gripper_mesh_pose.pose.position.z   = -0.24,-0.45,0.21
